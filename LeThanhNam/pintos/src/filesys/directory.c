...
// phần mới thêm ngoặc cho vòng for
            ...
            struct inode **inode)
{
  ...
  ASSERT (dir != NULL);
  ASSERT (name != NULL);
// sửa phần này để truy nhập đường dẫn có ..
  if (strcmp(".", name) == 0) {
...
// phần này mới
/*Section 6 -- isdir()
Get file pointer and then inode from fd in syscall.c
Calls inode_isdir() in inode.c*/
